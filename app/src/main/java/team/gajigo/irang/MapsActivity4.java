...
public class MapsActivity4 extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, GoogleMap.OnMapClickListener  {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mClusterManager.setOnClusterItemClickListener(new ClusterManager.OnClusterItemClickListener<MyItem>() {
            ...
            public boolean onClusterItemClick(MyItem myItem) {
                ...
                Glide.with(MapsActivity4.this).load(marketImg).thumbnail(01.f).fitCenter().into(map_marketImg);
                ...
                CustomInfoWindowAdapter adapter = new CustomInfoWindowAdapter(MapsActivity4.this);
