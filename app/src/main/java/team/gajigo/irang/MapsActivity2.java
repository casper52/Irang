...
public class MapsActivity2 extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, GoogleMap.OnMapClickListener  {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mClusterManager.setOnClusterItemClickListener(new ClusterManager.OnClusterItemClickListener<MyItem>() {
            ...
            public boolean onClusterItemClick(MyItem myItem) {
                ...
                Glide.with(MapsActivity2.this).load(marketImg).thumbnail(01.f).fitCenter().into(map_marketImg);
